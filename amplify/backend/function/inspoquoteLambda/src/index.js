...
async function updateQuoteDDBObject() {
    ...
    try {
        ...
        return await docClient.update(quoteParams).promise();
    } catch (error) {
...
<!--              <circle cx="382" cy="76" r="44" fill="rgba(255, 255, 255, 0.155)"/>-->
            ...
            }" class="footerStyles">Developed by Ian Duncan | Quotes from ZenQuotes.io</text>
          </svg>
        `;
        ...
        const backgroundImages = [
            ...
            "backgrounds/Flare.png",
            "backgrounds/Hydrogen.png",
            "backgrounds/Ibiza-Sunset.png",
            "backgrounds/JShine.png",
            "backgrounds/Kye-Meh.png",
            "backgrounds/Meridian.png",
            "backgrounds/Moon-Purple.png",
            "backgrounds/Purpink.png",
            "backgrounds/Radar.png",
            "backgrounds/Sin-City-Red.png",
            "backgrounds/Ultra-Voilet.png",
            "backgrounds/Wiretap.png",
